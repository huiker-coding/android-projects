package com.yinliubao.client.functions.reset;
...
import com.yinliubao.client.functions.reset.bean.ReqPwdResetVo;
...
public class ResetActivity extends BaseActivity
{
	...
	private void sendRequestRegist()
	{
		...
		ReqPwdResetVo reqPwdResetVo = new ReqPwdResetVo();
		reqPwdResetVo.setTerminal_userid(et_account.getText().toString());
		reqPwdResetVo.setUser_reset_pwd(Md5Helper.md5(et_password.getText().toString()));
		reqPwdResetVo.setIdt_code(et_verify_code.getText().toString());

		CommonRequestVo vo = new CommonRequestVo();
		vo.setRequest("flow.base.terminal.register");
		vo.setJsondata(reqPwdResetVo);
